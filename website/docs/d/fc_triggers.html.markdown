...
* `triggers` - A list of FC triggers. Each element contains the following attributes:
  ...
  * `trigger_type` - Type of the trigger. Valid values: `oss`, `log`, `timer` and `http`.
  ...
  * `raw_trigger_config` - JSON-encoded trigger configuration. See [Configure triggers and events](https://www.alibabacloud.com/help/doc-detail/70140.htm) for more details.
