		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr("data.alicloud_slb_server_groups.slb_server_groups", "slb_server_groups.0.backend_servers.#", "1"),
					resource.TestCheckResourceAttrSet("data.alicloud_slb_server_groups.slb_server_groups", "slb_server_groups.0.backend_servers.0.instance_id"),
					resource.TestCheckResourceAttr("data.alicloud_slb_server_groups.slb_server_groups", "slb_server_groups.0.backend_servers.0.weight", "100"),
				),
			},
		},
	})
