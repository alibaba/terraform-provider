		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttrSet("data.alicloud_fc_triggers.triggers", "triggers.0.source_arn"),
					resource.TestCheckResourceAttr("data.alicloud_fc_triggers.triggers", "triggers.0.trigger_type", "log"),
					resource.TestCheckResourceAttrSet("data.alicloud_fc_triggers.triggers", "triggers.0.invocation_role"),
					resource.TestCheckResourceAttrSet("data.alicloud_fc_triggers.triggers", "triggers.0.raw_trigger_config"),
